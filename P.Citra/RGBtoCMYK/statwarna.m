...
for baris = 1:m
  for kolom = 1:n
    jum_dev_r = jum_dev_r +(RGB(baris, kolom,1)- mean_r)^2;
    jum_dev_g = jum_dev_g +(RGB(baris, kolom,2)- mean_g)^2;
    jum_dev_b = jum_dev_b +(RGB(baris, kolom,3)- mean_b)^2;

    jum_skew_r = jum_skew_r +(RGB(baris, kolom,1)- mean_r)^3;
    jum_skew_g = jum_skew_g +(RGB(baris, kolom,2)- mean_g)^3;
    jum_skew_b = jum_skew_b +(RGB(baris, kolom,3)- mean_b)^3;

    jum_cur_r = jum_cur_r +(RGB(baris, kolom,1)- mean_r)^4;
    jum_cur_g = jum_cur_g +(RGB(baris, kolom,2)- mean_g)^4;
    jum_cur_b = jum_cur_b +(RGB(baris, kolom,3)- mean_b)^4;
  end
end
